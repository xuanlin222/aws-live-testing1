...
def Applyleave():
    ...
    insert_sql = "INSERT INTO empApplyLeave VALUES (%s, %s, %s, %s, %s, %d, %s, %s, %s, %s, %s)"
    cursor = db_conn.cursor()
    ...
    try:
        ...
        cursor.execute(insert_sql, (emp_id, emp_name, emp_department, emp_position, type_of_leave, leave_days, leave_start_date, leave_end_date, 
        leave_reason, manager_name, manager_email))
        db_conn.commit()
        #emp_name = "" + first_name + " " + last_name
        # Uplaod image file in S3 #
        #emp_image_file_name_in_s3 = "emp-id-" + str(emp_id) + "_image_file"
 ...
 #           object_url = "https://s3{0}.amazonaws.com/{1}/{2}".format(
  #              s3_location,
   #             custombucket,
    ...
    print("all modification done...")
    return render_template('ApplyLeaveOutput.html', name=emp_name)   
